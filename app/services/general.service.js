...
.factory('generalService', function($rootScope, $http, generalUtility) {
	...
	generalService.getTraineeMeasurements = function(traineeId) {
	...
	generalService.login = function(email, password) {
		var endpoint = '/login';
		var url = $rootScope.healthmastersAPI + endpoint;
	...
	generalService.insertNewTrainee = function(newTrainee) {
	...
	generalService.updateTrainee = function(trainee) {
	...
	generalService.deleteTrainee = function(traineeId) {
	...
	generalService.insertNewMeasurement = function(newMeasurement) {
	...
	generalService.deleteMeasurement = function(trainee_id, measurement_id, measurement_date) {
	...
	generalService.getUserInfo = function() {
	...
	generalService.updateUserInfo = function(userId, newInfo) {
	...
	generalService.updateUserPassword = function(newPassword, currentPassword) {
